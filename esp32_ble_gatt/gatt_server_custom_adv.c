#include "gatt_server_custom_adv.h"
...
void send_ble_msg(uint8_t *value, uint16_t value_len)
{
...
void app_main(void){
    ...
    esp_ble_gap_set_rand_addr(custom_mac);

    esp_ble_gatts_register_callback(gatts_event_handler);
    esp_ble_gap_register_callback(gap_event_handler);
    esp_ble_gatts_app_register(PROFILE_A_APP_ID);
    esp_ble_gatt_set_local_mtu(local_mtu_step);
